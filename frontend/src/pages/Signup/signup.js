        ...
        <div id="container">
            <div id="login">
                ...
                <form action="">
                    ...
                    <div className="inputArea username">
                        <input type="text" placeholder="Endereço de email" name="email" id="email" autoComplete="off"/>
                    ...
                    <div className="inputArea">
                        <input type="submit" id="submit" value="Cadastrar-me"/>
                    </div>
                    <a href="/login">voltar para área de login</a>
                </form>
            </div>
        </div>
    )
